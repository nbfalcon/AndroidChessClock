...
public class BuiltinTimeControls {
    public final PlayerClockTemplate[] builtin = new PlayerClockTemplate[]{
            new SingleStageTimeControlTemplate(TimeControlStageTemplate.Type.FISHER, 5 * 300 * 1000, 0),
            new SingleStageTimeControlTemplate(TimeControlStageTemplate.Type.FISHER, 300 * 1000, 0),
            new SingleStageTimeControlTemplate(TimeControlStageTemplate.Type.FISHER, 120 * 1000, 1000)
    };
